...
public class CompaniesFacade extends ClientFacade {
	...
	public Company getCompanyDetalis(int companyID) {
		return companiesDAO.getOneCompany(companyID);
	}

	public int getCompanyIdFromDbdao(String email, String password) {
		return companiesDAO.getCompanyID(email, password);
	}
}
